...
public class ArrayX {
	...
	// If list is not full, we add the given object to the list. If not, we double
	// the capacity and add the object.
	...
	// If list is not full, we add the given object to the given index of list. If
	// not, we double the capacity and add the object.
	...
	// It is the remove method which deletes the object according to given index and
	// arrange the list to fill the deleted index.
	...
	// It is the remove method which deletes the object from the front of the list
	// and arrange the list to fill the first index.
	...
	// We make all the index null. It is better to make only number of objects zero
	// but we cannot be sure that it can occur some problem in other methods.
	public void clear() {
