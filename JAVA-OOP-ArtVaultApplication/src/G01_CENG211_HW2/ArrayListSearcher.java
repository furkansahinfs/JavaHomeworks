...
public class ArrayListSearcher implements ISearchable{
	...
	public void search() {
		...
		System.out.println("\n\n");
		ArrayListSorter ALS = new ArrayListSorter(vault); // We create a ArrayListSorter object which takes a parameter of vault.
		// We want to reach name sorted lists using ALS.
		
		// In for loop we travel to name sorted architect list to reach architect objects
		// if given string is in an architect object's string, we print the object's definition.
		...
		// In for loop we travel to name sorted architecture list to reach architecture objects
		// if given string is in an architecture object's string, we print the object's definition.
		...
		// if given string is in a artist object's string, we print the object's definition.
		...
		// if given string is in a painting object's string, we print the object's definition.
		...
		// In for loop we travel to name sorted sculpture list to reach sculpture objects
		// if given string is in a sculpture object's string, we print the object's definition.
