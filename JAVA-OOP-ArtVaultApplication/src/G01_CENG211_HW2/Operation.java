...
public class Operation {
	...
	public void operation() {
		...
		try {
			while (true) {
				...
				case 3:
					trade(buyer1, buyer2, buyer3, buyer4, seller);
					break;
	...
	public void printTheList(int listChoice, BufferedReader reader, Vault vault) throws IOException {
		int sortChoice;
		ArrayList<Object> list; // it is the sorted list taken from ArrayListSorter.
		ArrayListSorter ALS = new ArrayListSorter(vault); // to sort the list, we create an arraylistsorter objects. To
															// reach list, it takes a parameter : vault.
		...
		case 1: // painting list - sort choices
			...
			list = ALS.sort(listChoice, sortChoice); // according to sorted choice, it returns the sorted
														// list.
	...
	public void trade(Buyer buyer1, Buyer buyer2, Buyer buyer3, Buyer buyer4, Seller seller) {
		...
		// Take an random artwork from seller's list which holds tradeable artworks and
		// try to sell them to buyer.
		...
		System.out.println("BUYER 1 bought: \n" + buyer1.getList().get(0).toString() + "Cost: "
				+ buyer1.getList().get(0).calculateCost() + " TL" + "\n\n");
		System.out.println("BUYER 2 bought: \n" + buyer2.getList().get(0).toString() + "Cost: "
				+ buyer2.getList().get(0).calculateCost() + " TL" + "\n\n");
		System.out.println("BUYER 3 bought: \n" + buyer3.getList().get(0).toString() + "Cost: "
				+ buyer3.getList().get(0).calculateCost() + " TL" + "\n\n");
		System.out.println("BUYER 4 bought: \n" + buyer4.getList().get(0).toString() + "Cost: "
				+ buyer4.getList().get(0).calculateCost() + " TL" + "\n\n");
