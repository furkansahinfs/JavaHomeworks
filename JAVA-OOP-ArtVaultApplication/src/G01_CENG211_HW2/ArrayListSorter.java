...
public class ArrayListSorter {
	...
	// sort method takes two parameter of integer. Choice is the list choice and
	// choice2 is the sort choice.
	public ArrayList<Object> sort(int choice, int choice2) {
		...
		case 1: // painting list
			...
			// using bubble sort we make a swap. If ith object is bigger than the other
			// objects using compare method, we make a swap between two object.
			for (int i = 0; i < list.size(); i++) {
				for (int j = i + 1; j < list.size(); j++) {
					if (((IComparable) list.get(i)).compareTo(list.get(j), choice2) > 0) { // compareto takes two
																							// parameters : Object and
																							// sort choice
					...
					// If objects are equal to each other, we compare them according to their names
					// and make a swap between two objects.
