...
public class PlasticTrashBag<T> implements IBag<T> {
	...
	private T[] plastictrashbag = (T[]) new Object[DEFAULT_CAPACITY];
	...
	public PlasticTrashBag(int boyut) 
	{
		plastictrashbag = (T[]) new Object[boyut];
	}
	...
	public boolean add(T newItem) 
	{
		...
		if (!isFull())
		{
			plastictrashbag[numberOfEntries] = newItem;
	    	numberOfEntries++;	    
	    	result = true;
	    }	   
	    else
	...
	public boolean isFull() 
	{
		...
		if( numberOfEntries >= plastictrashbag.length)
		{
			System.out.println("PlasticTrashBag is full! You can not add any object until you remove object from plastic bag.");
			 return true;
		}
		else
		{
	...
	public T removeByIndex(int index) 
	{
		...
		if(!isEmpty() && index >=0) 
		{
			result= plastictrashbag[index-1];			
			plastictrashbag[index-1] = plastictrashbag[numberOfEntries-1];
			plastictrashbag[numberOfEntries-1] = null;
			numberOfEntries --;
			System.out.println("Item is removed from PlasticTrashBag");
		}
	...
	public T remove(T item)
	{
		...
		for(int i=0;i<numberOfEntries;i++)
		{
			...
			{
				System.out.println("Item is removed from PlasticTrashBag");
				plastictrashbag[i]=plastictrashbag[numberOfEntries-1];
				plastictrashbag[numberOfEntries-1] = null;
				numberOfEntries--;
				break;
			}
	...
	public void displayItems() {
		...
		{		
			for (int i=0;i<numberOfEntries;i++) 
			{
				System.out.println(plastictrashbag[i].toString());
			}
		}
		else
		{
			System.out.println("PlasticTrashBag is empty.");
		}
	}
