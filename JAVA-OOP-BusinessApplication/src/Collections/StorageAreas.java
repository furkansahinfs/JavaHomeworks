...
public class StorageAreas {
	...
	/**
	 * Firstly we analyse the type of countable item and according to type we invoke
	 * the add method using parameter of area for item and item and return the
	 * situations
	 */
	...
	/**
	 * Firstly we analyse the type of countable item and according to type we invoke
	 * the remove method using parameter of area for item and item and return the
	 * situations
	 */
