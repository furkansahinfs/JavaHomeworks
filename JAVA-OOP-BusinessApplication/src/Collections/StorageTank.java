...
public class StorageTank {
	...
	/**
	 * We control that there exists enough space in the tank if space is okey, then
	 * we add the item to the tank and set the litre of area.
	 */
	...
	/**
	 * If there exists enough litre of item to remove in the tank, we remove the
	 * item and set the litre of tank.
	 */
