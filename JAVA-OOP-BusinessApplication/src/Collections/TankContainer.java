...
public class TankContainer implements IContainer {
	...
	/**
	 * Firstly we analyse the type of the item (milk or cream) According to type we
	...
	public <T> boolean remove(T obje) {
		...
		default:
			throw new IllegalArgumentException(
					"Unexpected item is tried to be given to the tank container: " + obje.getClass().getSimpleName());
		}
	...
	/**
	 * Firstly we analyze the type of the item (milk or cream) and create a new item
	 * which its litre is equal to litre of item in the container. After that we try
	 * to transfer (add to facitily) the item. If transfer is succesfull we invoke
	 * the remove method of container. If given item is unexpected type, we throw an
